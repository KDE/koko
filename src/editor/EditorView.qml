            ...
            displayComponent: Controls.ToolButton {
                ...
                Controls.Popup {
                    ...
                    function resetToPixels(): void {
                        widthSpinBox.to = Qt.binding(() => imageView.document.imageSize.width * 8)
                        heightSpinBox.to = Qt.binding(() => imageView.document.imageSize.height * 8)
                        resizePopup.targetSize = Qt.binding(() => imageView.document.imageSize)
                    }
                    function resetToPercentage(): void {
                        widthSpinBox.to = 800
                        heightSpinBox.to = 800
                    ...
                    TextMetrics {
                        id: widthTextMetrics
                        text: (imageView.document.imageSize.width * 10).toLocaleString(widthSpinBox.locale, 'f', 0)
                    }
                    TextMetrics {
                        id: heightTextMetrics
                        text: (imageView.document.imageSize.height * 10).toLocaleString(heightSpinBox.locale, 'f', 0)
                    }
