...
Kirigami.Page {
    ...
    ListView {
        ...
        KAC.FloatingToolBar {
            id: zoomBar
            readonly property bool shouldShow: !Kirigami.Settings.isMobile && listView.currentItem !== null && root.mainWindow.controlsVisible && listView.currentItem.type != Koko.FileInfo.VideoType
