...
Kirigami.ScrollablePage {
    ...
    readonly property bool canNavigate: galleryModel instanceof Koko.GalleryFolderModel
    ...
    title: "TODO" // TODO: Current folder/collection name (model export?)
    titleDelegate: !Kirigami.Settings.isMobile && page.isFolderView ? folderTitleComponent : normalTitleComponent

    header: Loader {
        height: active ? implicitHeight : 0
        // On mobile, sharing the navigation with actions takes too much width
        active: Kirigami.Settings.isMobile && page.isFolderView
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                Loader {
                    ...
                    active: true
                    sourceComponent: folderTitleComponent
                }
    ...
    Component {
        ...
        Kirigami.Heading {
            Layout.fillWidth: true
            Layout.maximumWidth: implicitWidth + 1 // The +1 is to make sure we do not trigger elide at max width
            Layout.minimumWidth: 0

            text: page.title
            opacity: page.isCurrentPage ? 1 : 0.4 // TODO: What? Probably remove
            maximumLineCount: 1
            ...
            onClicked: {
                if (selectionModel.hasSelection || Koko.Controller.keyboardModifiers() & Qt.ControlModifier) {
                    ...
                    switch (delegate.itemType) {
                        case Koko.AbstractImageModel.Media:
                            if (page.isTrashView) {
                                break;
                            }
