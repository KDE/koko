...
/*!
 * Model for browsing content by location
 */
class GalleryLocationModel : public AbstractNavigableGalleryModel
{
    Q_OBJECT
    QML_ELEMENT

public:
    explicit GalleryLocationModel(QObject *parent = nullptr);
